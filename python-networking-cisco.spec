...
mkdir %{buildroot}%{_sysconfdir}/saf
mv %{buildroot}/usr/etc/saf/*.ini %{buildroot}%{_sysconfdir}/saf/
...
# Install saf systemd units
mv %{buildroot}/usr/etc/saf/init/fabric-enabler-agent.service %{buildroot}%{_unitdir}/fabric-enabler-agent.service
mv %{buildroot}/usr/etc/saf/init/fabric-enabler-server.service %{buildroot}%{_unitdir}/fabric-enabler-server.service

mkdir -p %{buildroot}/%{_sysconfdir}/neutron/conf.d/neutron-cisco-cfg-agent

# remove Ubuntu systemd units
